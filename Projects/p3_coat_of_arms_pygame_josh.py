...
s3 = create_sprite("computer2", 100, -100)
s4 = create_sprite("rock_climbers2", -100, 100)

message1 = create_sprite("alien",-200,200)
message1.color("black")
message1.write("Josh Kurisko",font = ("Arial", 40, "normal"))
message1.hideturtle()

message2 = create_sprite("alien",-200,-280)
message2.color("SkyBlue")
message2.write("Python is fun!",font = ("Arial", 40, "normal"))
message2.hideturtle()
