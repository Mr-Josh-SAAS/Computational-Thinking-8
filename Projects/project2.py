...
if pirate_points>princess_points and pumpkin_points:
        print ("You should be a pirate for Halloween")
elif princess_points>pirate_points and pumpkin_points:
        print ("You should be a princess for Halloween")
elif pumpkin_points>pirate_points and princess_points:
