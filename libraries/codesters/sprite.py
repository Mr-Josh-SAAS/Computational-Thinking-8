                ...
                if isinstance(e, SpriteClass):
                    if self.check_two_sprites_for_collision(e):
                        ...
                        if e.goal and self.collision_goal_function is not None:
                            if len(inspect.getfullargspec(self.collision_goal_function)[0]) == 2:
                                self.collision_goal_function(self, e)
                            elif len(inspect.getfullargspec(self.collision_goal_function)[0]) == 1:
                            ...
                            if len(inspect.getfullargspec(self.collision_hazard_function)[0]) == 2:
                                self.collision_hazard_function(self, e)
                            elif len(inspect.getfullargspec(self.collision_hazard_function)[0]) == 1:
                            ...
                            if len(inspect.getfullargspec(self.collision_function)[0]) >= 2:
                                self.collision_function(self, e)
                            elif len(inspect.getfullargspec(self.collision_function)[0]) == 1:
                        ...
                        if self.goal and e.collision_goal_function is not None:
                            if len(inspect.getfullargspec(e.collision_goal_function)[0]) == 2:
                                e.collision_goal_function(e, self)
                            elif len(inspect.getfullargspec(e.collision_goal_function)[0]) == 1:
                            ...
                            if len(inspect.getfullargspec(e.collision_hazard_function)[0]) == 2:
                                e.collision_hazard_function(e, self)
                            elif len(inspect.getfullargspec(e.collision_hazard_function)[0]) == 1:
                                e.collision_hazard_function(Manager.elements.index(self))
                            else:
                                self.collision_hazard_function()
                        elif self.collision and e.collision_function is not None:
                            if len(inspect.getfullargspec(e.collision_function)[0]) >= 2:
                                e.collision_function(e, self)
                            elif len(inspect.getfullargspec(e.collision_function)[0]) == 1:
        ...
        for key in Manager.keys_pressed:
            if key in self.key_functions.keys() and Manager.frame_number % Manager.event_delay == 0:
                ...
                for i in self.key_functions[key]:
                    if len(inspect.getfullargspec(i)[0]) == 0:
                        i()
                    elif len(inspect.getfullargspec(i)[0]) == 1:
                        i(self)
        if self.drag:
    ...
    def event_key(self, key, function):
        ...
        def f(event):
            ...
            if len(inspect.getfullargspec(function)[0]) == 0:
                function()
            elif len(inspect.getfullargspec(function)[0]) == 1:
                function(self)
